...
const routes = [
  ...
  // AC product detail pages
  {
    ...
    subtopics: ["Spider Mini — Compact 3.3 kW Single-Phase AC Home EV Charger", "Spider Mini Key Features — 3.3 kW Single-Phase AC Charger", "Who Should Choose the Spider Mini? — Apartments, Homes & Light EVs", "Technical Specifications — IP67, RFID, OCPP 1.6J", "Installation Guide — Spider Mini in Andhra Pradesh & Telangana"],
  ...
  },
  {
    ...
    subtopics: ["Spider Smart — 7.4 kW Type 2 AC EV Charger", "Spider Smart Key Features — 7.4 kW Type 2 Smart AC Charger", "Dynamic Load Management — Why It Matters for Home EV Charging", "App Control & Remote Monitoring — Smart Charging from Your Phone", "Type 2 Connector — Compatible with All Major EVs in India", "Home vs Commercial Use — Is Spider Smart Right for You?"],
  ...
  },
  {
    ...
    subtopics: ["Spider Blaze — 22 kW Three-Phase AC EV Charger", "Spider Blaze Key Features — 22 kW Three-Phase AC Charger", "Fleet & Commercial Charging — Best Use Cases for Spider Blaze", "Technical Specifications — OCPP 1.6J, IP67, Three-Phase Power", "Spider Blaze vs Spider Strike — Which Commercial AC Charger Is Right for You?"],
  ...
  },
  {
    ...
    subtopics: ["Spider Strike — 40 kW High-Power Three-Phase AC EV Charger", "Spider Strike Key Features — 40 kW Three-Phase AC EV Charger", "Fleet Charging Use Case — Commercial & Industrial Applications", "Technical Specifications — BIS, OCPP 1.6J, IP67, Three-Phase Power", "Spider Strike vs Spider Blaze — Which AC Charger Is Right for You?"],
  ...
  },
  {
    ...
    subtopics: ["Spider Dash — 80 kW Dual-Gun AC EV Charger for High-Volume Sites", "Spider Dash Key Features — 80 kW Dual-Gun Three-Phase AC Charger", "Dual-Gun Charging — Charge Two EVs Simultaneously", "Ideal Sites — Malls, Corporate Parks & High-Throughput Locations", "Technical Specifications — OCPP 1.6J, IP67, BIS Certified"],
  ...
  },
  {
    ...
    subtopics: ["Spider Spark — 60 kW Dual-Connector DC Fast EV Charger", "Spider Spark Key Features — 60 kW DC Fast Charger with Dual Connectors", "Why Dual Connectors Matter — CCS2 + CHAdeMO for All EVs", "Public & Commercial Use Cases for Spider Spark", "Technical Specifications — OCPP 1.6J, IP67, BIS Certified"],
  ...
  },
  {
    ...
    subtopics: ["Spider Falcon — 60 kW CCS2 DC Fast EV Charger", "Spider Falcon Technical Specifications — 60 kW CCS2 DC Fast Charger", "CCS2 Connector — Compatible with All Major 4-Wheeler EVs in India", "Best Use Cases — Public Networks, Malls & Commercial EV Hubs", "IP67 & OCPP 1.6J — Why Spider Falcon Is Built for Indian Conditions"],
  ...
  },
  {
    ...
    subtopics: ["Spider Ultra — 120 kW DC Fast EV Charger", "Spider Ultra Technical Specifications — 120 kW DC Fast Charger", "Dual Connector — CCS2 & CHAdeMO for Maximum EV Compatibility", "Best Use Cases — Public Networks, Commercial Hubs & Highways", "Spider Ultra vs Spider Surge — Choosing the Right High-Power Charger"],
  ...
  },
  {
    ...
    subtopics: ["Spider Hulk — 240 kW Ultra-Rapid DC Fast EV Charger", "Spider Hulk Technical Specifications — 240 kW DC Fast Charger", "Connector Types — CCS2 & CHAdeMO for All EV Models", "Ideal Use Cases — Highway Hubs, Bus Depots & Large Fleets", "Why Choose Spider Hulk for Heavy-Duty EV Infrastructure in India"],
