 ...
 */
const newsItems = [
  { id: 1, category: "Partnerships", title: "SpiderEV partners with India Post to deploy EV chargers at 500+ post offices across India", date: "2026-01-15", image: "/news/spiderev-india-post-partnership.jpg" },
  { id: 2, category: "Product Launches", title: "SpiderEV launches Spider Ultra — India's first 240 kW DC ultra-rapid charger", date: "2025-12-20", image: "/news/spider-ultra-launch.jpg" },
  { id: 3, category: "Government", title: "SpiderEV selected as preferred charging infrastructure partner under FAME II scheme", date: "2025-12-10", image: "/news/fame-ii-partnership.jpg" },
  { id: 4, category: "Expansions", title: "SpiderEV expands network to 15 new cities with 200 new charging stations", date: "2025-12-01", image: "/news/network-expansion.jpg" },
  { id: 5, category: "Awards", title: "SpiderEV wins 'Best EV Charging Infrastructure Company 2025' at EV India Awards", date: "2025-11-15", image: "/news/ev-india-awards-2025.jpg" },
  { id: 6, category: "Partnerships", title: "SpiderEV signs MoU with Hyderabad Metro Rail for charging stations at 40 metro stations", date: "2025-11-05", image: "/news/hyderabad-metro-mou.jpg" },
  { id: 7, category: "Product Launches", title: "SpiderEV App crosses 100,000 downloads — now available in 9 regional languages", date: "2025-10-20", image: "/news/app-100k-downloads.jpg" },
  { id: 8, category: "Government", title: "SpiderEV completes installation of 500 DC chargers along NH-48 under government mandate", date: "2025-10-10", image: "/news/nh48-charger-installation.jpg" },
];
  ...
  >
    ...
    <div className="p-5 flex flex-col flex-1">
      ...
      <div className="flex items-center justify-between">
        <time dateTime={item.date} className="text-gray-400 text-xs">
          {new Intl.DateTimeFormat("en-IN", { day: "numeric", month: "short", year: "numeric" }).format(new Date(`${item.date}T00:00:00`))}
        </time>
        <span className="text-gray-400 text-xs">Details coming soon</span>
      </div>
    </div>
  </motion.article>
);
  ...
  return (
    <PageLayout>
      ...
      <SEO
        ...
        breadcrumbs={getBreadcrumbSchema([{name: "Home", url: "https://spiderenergy.in/"}, {name: "News"}])}
      />
